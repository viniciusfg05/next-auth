...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  async function signIn({ email, password }: SingInCredentials) {
    try {
      ...
      setCookie( undefined, 'nextauth.token', token) //1° - contexto da req (undefined) sempre que a acão é pelo lado do browser e SSG, 2° nome do cookie, 3° valor do token, 4° informações add
